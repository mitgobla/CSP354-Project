...
class Ui_Debug(object):
    ...
    def retranslateUi(self, Debug):
        ...
        item = self.debugList.item(0)
        item.setText(_translate("Debug", "Output 1"))
        item = self.debugList.item(1)
        item.setText(_translate("Debug", "Output 2"))
